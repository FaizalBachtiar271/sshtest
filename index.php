...
<nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
  <div class="container">
    <div class="navbar-header">
      ...
      <a class="navbar-brand page-scroll" href="#page-top"> <i class="fa fa-paper-plane-o"></i> Radiance</a> </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-10 col-md-offset-1">
          <h1>We are <span class="brand-heading">Radiance</span></h1>
...
<div id="team" class="text-center">
  <div class="container">
    <div class="section-title center">
      <h2>My Team</h2>
      <hr>
      <p>Kepuasan client adalah kepuasan kami</p>
    </div>
    <div id="row">
